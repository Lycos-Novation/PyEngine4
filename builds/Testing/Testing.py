...
def launch():
    ...
    particlecomponent = ParticleComponent(engine, Color.from_rgba(252, 255, 255, 255), Color.from_rgba(0, 0, 0, 255), Vec2(20, 20), Vec2(0, 0), Vec2(0, 359), Vec2(100, 100), 1, 0.01, 10)
